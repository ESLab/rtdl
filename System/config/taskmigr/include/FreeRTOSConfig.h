...
#define configMINIMAL_STACK_SIZE		( ( unsigned portSHORT ) 256 * 16 )
...
#define INCLUDE_xTaskAttach					1
#define INCLUDE_xTaskDetach					1
...
#define configMIS_SECTION_ADDRESS				((void *)0x60400000)
